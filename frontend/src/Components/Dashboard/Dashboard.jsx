  ...
  return (
    <div className="dashboard_page">
        ...
        <div className="button_container">
            ...
            <form action="api/login/logout"><button id='logout'>Logout</button></form>
        </div>
        ...
        <div className="crud_container">
            ...
            <form action="/api/analog/create" method='post'>
                <h3>CREATE ANALOG</h3>
            ...
            <form action="/api/analog/edit" method='post'>
                <h3>EDIT ANALOG</h3>
            ...
            <form action="/api/analog/view" method='get'>
                <button>View All Analog Watches</button>
            </form>
            <div>
            <form action="/api/analog/deleteid" method='post'>
                <input type="text"  placeholder='Enter id' name='deletebyid'/>
                <button>Delete selected one</button>
            </form>
            </div>
            <div>
                <form action="api/analog/deleteall" method='post' style={{height:"max-content"}}>
                <button
                  onClick={(e) => {
            ...
            :null}
              {display==="digital" ?
            <div className="forms_container">
            <form action="/api/digital/create" method='post'>
            ...
            <form action="/api/digital/edit" method='post'>
                <h3>EDIT DIGITAL</h3>
                <input type="text" placeholder='ID of Item to change' autoComplete='off'  name='edit_id'/>
                <input type="text" placeholder='Enter New Watch-Name' autoComplete='off'   name='watchname'/>
                <input type="text" placeholder='Enter New Image-url'  autoComplete='off'  name='ImageUrl'/>
            ...
            <div className="delete_view">
            <form action="/api/digital/view" method='get'>
                <button>View All Digital Watches</button>
            </form>
            <div>
            <form action="/api/digital/deleteid" method='post'>
                <input type="text"  placeholder='Enter id' name='deletebyid'/>
                <button>Delete selected one</button>
            </form>
            </div>
            <div>
                <form action="api/digital/deleteall" method='post' style={{height:"max-content"}}>
                <button
                  onClick={(e) => {
                    if (!window.confirm("Are you sure you want to delete all analog watches?")) {
                      e.preventDefault();
            ...
            :null}
              {display==="Smartwatch" ?
                 <div className="forms_container">
                 <form action="/api/smartwatch/create" method='post'>
                 ...
                 <form action="/api/smartwatch/edit" method='post'>
                 ...
                 <div className="delete_view">
                 <form action="/api/smartwatch/view" method='get'>
                     <button>View All SMART-WATCHES</button>
                 </form>
                 <div>
                 <form action="/api/smartwatch/deleteid" method='post'>
                     <input type="text"  placeholder='Enter id' name='deletebyid'/>
                     <button>Delete selected one</button>
                 </form>
                 </div>
                 <div>
                     <form action="/api/smartwatch/deleteall" method='post' style={{height:"max-content"}}>
                     <button
                       onClick={(e) => {
                         if (!window.confirm("Are you sure you want to delete all analog watches?")) {
                           e.preventDefault();
            ...
            :null}
              {display==="Retro" ?
               <div className="forms_container">
               <form action="/api/retro/create" method='post'>
               ...
               <form action="/api/retro/edit" method='post'>
               ...
               <div className="delete_view">
               <form action="/api/retro/view" method='get'>
                   <button>View All RETRO WATCH</button>
               </form>
               <div>
               <form action="/api/retro/deleteid" method='post'>
                   <input type="text"  placeholder='Enter id' name='deletebyid'/>
                   <button>Delete selected one</button>
               </form>
               </div>
               <div>
                   <form action="api/retro/deleteall" method='post' style={{height:"max-content"}}>
                   <button
                     onClick={(e) => {
                       if (!window.confirm("Are you sure you want to delete all analog watches?")) {
                         e.preventDefault();
            ...
            { display==="Customers" ?
             ...
             <form action="api/login/userlist" method='get'>
                 <button>View Users</button>
             </form>
             <form action="api/login/deleteid" method='post'>
              <input type="text" placeholder='Enter id' name='id_user' />
              <button>Delete user</button>
             </form>
             <form action="api/login/deleteall" method='post'>
             <button
               onClick={(e) => {
            ...
            <form method='post' action="api/promoted/add">
            ...
            <form action="api/promoted/view" method='get'>
            <button>View Promoted</button>
            </form>
            <form action="api/promoted/delete" method='post' style={{paddingTop:"15px"}}>
